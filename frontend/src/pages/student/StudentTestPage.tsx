      ...
      <div className="fixed top-0 left-0 min-h-screen h-screen w-screen flex flex-col justify-center items-center bg-gradient-to-br from-[#253347] via-[#253347] to-[#b4c5e4] font-[Comic Sans MS, Comic Sans, cursive, sans-serif] overflow-hidden z-40">
        ...
        {submitted && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl w-full flex flex-col items-center border-4 border-green-400">
              {!showScoreDetails ? (
                <>
                  <span className="text-6xl mb-4">🎉</span>
                  <span className="text-3xl md:text-4xl font-extrabold text-green-600 mb-4 text-center">Great job!</span>
                  <span className="text-xl md:text-2xl font-bold text-gray-700 mb-6 text-center">You finished the test! Tap below to see how you did.</span>
                  <button
                    className="mt-2 px-8 py-3 bg-green-500 text-white rounded-xl text-lg font-bold shadow hover:bg-green-600 transition-all"
                ...
                <>
                  ...
                  <button
                    className="mt-2 px-8 py-3 bg-blue-500 text-white rounded-xl text-lg font-bold shadow hover:bg-blue-600 transition-all"
        ...
        <div className="flex flex-col items-center w-full max-w-5xl mx-auto px-4 py-8 font-[Quicksand,sans-serif] max-h-full overflow-hidden justify-center flex-1">
          {/* Top row: test name and question count */}
          <div className="w-full flex items-center justify-between mb-2">
            <span className="bg-black/30 text-white px-3 py-1 rounded-full text-sm font-bold">{test.testName}</span>
            <span className="bg-black/30 text-white px-3 py-1 rounded-full text-sm font-bold">{currentQuestion + 1} / {test.questions.length}</span>
          </div>
